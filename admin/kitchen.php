...
<?
$result = mysql_query("SELECT * FROM hb_equipment WHERE room_id=2 AND additional=0");
...
<?
$result = mysql_query("SELECT * FROM hb_equipment WHERE room_id=2 AND additional=1");
$row = mysql_fetch_array($result);
